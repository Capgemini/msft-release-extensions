using Capgemini.CapabilityCatalog.Client;
using Capgemini.CapabilityCatalog.Shared.Interceptors;
...
namespace Capgemini.CapabilityCatalog.Client
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddTransient<NotificationHttpInterceptor>();
            ...
            builder.Services.AddHttpClient("Capgemini.CapabilityCatalog.ServerAPI", client => client.BaseAddress = new Uri(builder.HostEnvironment.BaseAddress))
                .AddHttpMessageHandler<NotificationHttpInterceptor>()
