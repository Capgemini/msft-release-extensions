...
$itemsInfo = Get-WorkitemsForDeployment $adoConnection $ReleaseId $DefinitionId $DefinitionEnvironmentId $sourceBuildId
...
[string]$tableWorkITems = Write-MdTableFromWorkItems -WorkItems $itemsInfo.workItems
